...
describe("ProductMatcher", () => {
  ...
  describe("findExactMatch() - Exact Match Logic", () => {
    ...
    it("should handle Supabase error gracefully and fall back to fuzzy match", async () => {
      ...
      // Assert
      expect(consoleErrorSpy).toHaveBeenCalledWith("Error searching for exact match:", expect.any(Object));
  ...
  describe("findFuzzyMatch() - Fuzzy Match Logic", () => {
    ...
    it("should handle Supabase error in fuzzy match and fall back to create", async () => {
      ...
      // Assert
      expect(consoleErrorSpy).toHaveBeenCalledWith("Error searching for fuzzy match:", expect.any(Object));
  ...
  describe("createProduct() - Product Creation Logic", () => {
    ...
    it("should throw error when product creation fails", async () => {
      ...
      // Act & Assert
      await expect(productMatcher.findOrCreate("turmeric", userId)).rejects.toThrow("Failed to create product");

      expect(consoleErrorSpy).toHaveBeenCalledWith("Error creating product:", expect.any(Object));
    ...
    it("should throw error when insert returns no data", async () => {
      ...
      // Act & Assert
      await expect(productMatcher.findOrCreate("oregano", userId)).rejects.toThrow("Failed to create product");
