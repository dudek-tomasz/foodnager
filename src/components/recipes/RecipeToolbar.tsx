  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-6">
      ...
      <div className="flex-1 sm:max-w-md">
        <SearchBar value={searchValue} onChange={onSearchChange} loading={loading} />
      </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <FilterMultiSelect filters={filters} onChange={onFilterChange} availableTags={availableTags} />

        {/* Add Recipe Button - Mobile only */}
        <Button onClick={onAddRecipe} className="sm:hidden">
