...
export function EmptyState({ onAddRecipe, isSearchResult = false, searchQuery = "" }: EmptyStateProps) {
  if (isSearchResult) {
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4">
        ...
        <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Nie znaleziono przepisów</h2>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Nie masz jeszcze przepisów</h2>
      <p className="text-neutral-600 dark:text-neutral-400 text-center max-w-md mb-6">
