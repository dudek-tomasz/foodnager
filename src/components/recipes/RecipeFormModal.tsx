...
export function RecipeFormModal({
  ...
  const validateForm = (): boolean => {
    ...
    const productIds = formData.ingredients.map((ing) => ing.productId).filter((id): id is number => id !== null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "add") {
        ...
        savedRecipe = await apiClient.patch<RecipeDTO>(`/api/recipes/${recipe.id}`, updateDTO);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" aria-describedby="recipe-form-description">
        <DialogHeader>
          <DialogTitle>{mode === "add" ? "Dodaj przepis" : "Edytuj przepis"}</DialogTitle>
          <p id="recipe-form-description" className="sr-only">
            Formularz {mode === "add" ? "dodawania nowego" : "edycji"} przepisu. Wypełnij wymagane pola: tytuł,
        ...
        <form onSubmit={handleSubmit} className="space-y-6" aria-label="Formularz przepisu">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <p className="text-sm text-neutral-500 ml-auto">{formData.description.length}/500</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-sm text-neutral-500 ml-auto">{formData.instructions.length}/5000</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.cookingTime && <p className="text-sm text-red-500">{errors.cookingTime}</p>}
            </div>
