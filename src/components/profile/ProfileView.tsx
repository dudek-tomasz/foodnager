    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
        <p className="text-sm text-blue-700 dark:text-blue-400">
          💡 <strong>Planowane funkcje:</strong> W przyszłości będziesz mógł dodać zdjęcie profilowe, 
          zmienić hasło oraz zobaczyć statystyki swojej kuchennej aktywności.
        </p>
      </div>
    </div>
  );
